...
public class Ejemplo04 {
	...
	public static void main(String[] args) {
		...
		// Podemos pasarle a indexOf() un segundo parámetro que indique desde qué
		// poscición tiene que empezar a buscar.
		System.out.println("La palabra crees, a partir de la posición 12 vuelve a aparecer en la posición "
