...
public class Ejemplo06BorradoRecursivo {
	...
	private static void borrar(File file) {
		// Caso recursivo: file es una carptea, luego voy llamando al método borrar()
		// pasándole cada archivo o carpeta que contenga.
		if (file.isDirectory()) {
		...
		// Caso base: file es un archivo, y por tanto, puedo borrarlo con el método
		// delete() de File
