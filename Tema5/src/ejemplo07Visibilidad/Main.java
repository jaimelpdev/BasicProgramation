...
public class Main {
	...
	public static void main(String[] args) {
		...
		// Podemos acceder a coche1.modelo, ya que le hemos puesto un modificador
		// public, por tanto tiene visibilidad en todo el proyecto.
		coche1.modelo = "Toledo";

		// La clase Persona está en un paquete distinto que esta clase Main.
		// Para poder crear un objeto Persona he tenido que poner el constructor
		// implícito como "public".
		...
		// solo es visible desde su mismo paquete.

		// Podemos acceder a coche1.dni, ya que le hemos puesto un modificador
		// public, por tanto tiene visibilidad en todo el proyecto.
