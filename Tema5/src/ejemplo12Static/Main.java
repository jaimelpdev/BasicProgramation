...
public class Main {
	...
	public static void main(String[] args) {
		...
		// El atributo PI es estático, no hace falta crear un objeto de la clase
		...
		// Igualmente podemos acceder al atributo estático centilitros anteponiendo el
		// nombre de la clase(Unidades).
		// Cúantos litros son 50 cl.
		System.out.println("50 cl son " + 50 * Unidades.centilitros + " litros.");

		// Cuántos metros son 2.5km
		System.out.println("2.5 km son " + 2.5 * Unidades.kilometros + " metros.");

		// Comprobamos que al cambiar el atributo PI en un objetom cambia en cualquier
		...
		System.out.println("Área del circulo: " + Unidades.areaCirculo(20));
