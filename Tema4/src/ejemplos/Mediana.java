...
// Programa de consola que va a recibir 5 datos y nos va a mostrar la mediana de esos datos.
public class Mediana {
	...
	// Devuelve la mediana de un array de números enteros que ha recibido como
	// argumento.
